...
def send_event_to_server(event_data, server_url=None):
    ...
    if server_url is None:
        server_url = os.environ.get('OBSERVABILITY_SERVER_URL', 'http://localhost:4000/events')
    try:
        # Prepare the request
...
def main():
    ...
    parser.add_argument('--server-url',
                        ...
                        help='Server URL (default: $OBSERVABILITY_SERVER_URL or http://localhost:4000/events)')
